...
def main():
    ...
    parser.add_argument("--aesthetic", default="", help="审美风格（背景描述）")
    parser.add_argument("--color", default="", help="色调偏好（背景描述）")
    parser.add_argument("--scene", default="", help="场景描述（背景描述）")
    parser.add_argument("--lighting", default="", help="光影风格（背景描述）")
